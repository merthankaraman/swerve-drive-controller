...
/* USER CODE BEGIN PV */
float motor_speed_wanted = 1.0, motor_angle_wanted = 2.0;
float s1=3.14;
char ss[4];
...
void lcd_setCursor(uint8_t row,uint8_t col){
	...
	if ( row > 16 ) {
		row = 16-1;    // we count rows starting w/0
	}
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(STP_MS2_GPIO_Port, STP_MS2_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(STP_MS1_GPIO_Port, STP_MS1_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, STP_EN_Pin|STP_DIR_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : STP_MS2_Pin */
  GPIO_InitStruct.Pin = STP_MS2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(STP_MS2_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : STP_MS1_Pin STP_DIR_Pin */
  GPIO_InitStruct.Pin = STP_MS1_Pin|STP_DIR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : STP_EN_Pin */
  GPIO_InitStruct.Pin = STP_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(STP_EN_GPIO_Port, &GPIO_InitStruct);
